...
$route['domestic-tours-details/(:any)'] = 'user/domestic_tours_details/$1';
$route['international-tours'] = 'user/international_tours';
$route['international-tours-details/(:any)'] = 'user/international_tours_details/$1';
...
$route['ajax_insert_di_tour_booking_enquiry'] = 'user/ajax_insert_di_tour_booking_enquiry';
