                        ...
                        <th>Updated By</th> -->
                                ...
                                <? if (!empty($di_tour_booking_enquiry_data)) { ?>
                                    <tbody>
                                        ...
                                        foreach ($di_tour_booking_enquiry_data as $item) {
                                            $count++;
                                            ?>
                                            <tr>
                                                <td><?= $count ?>.</td>
                                                <?php if ($user_access->update_module == 1) { ?>
                                                    <td><input type="checkbox" name="sel_recds[]" id="sel_recds<?php echo $count; ?>"
                                                            value="<?php echo $item->di_tour_booking_enquiry_id; ?>" /></td>
                                                <? } ?>
                                                <td><a
                                                        href="<?= MAINSITE_Admin . $user_access->class_name . "/view/" . $item->di_tour_booking_enquiry_id ?>"><?= date("d-m-Y", strtotime($item->added_on)) ?></a>
                                                </td>
                                                ...
                                                <td>
                                                    <?php if (!empty($item->di_tour)): ?>
                                                        <?php if ($item->di_tour[0]->di_tour_variant == 1): ?>
                                                            Domestic Tours
                                                        <?php elseif ($item->di_tour[0]->di_tour_variant == 2): ?>
                                                            International Tours
                                                ...
                                                <td>
                                                    <?php if (!empty($item->di_tour)): ?>
                                                        <?php if (empty($item->di_tour[0]->is_discount)): ?>
                                                            ₹<?= $item->di_tour[0]->actual_price ?>
                                                        <?php else: ?>
                                                            ₹<?= $item->di_tour[0]->discounted_price ?>
                                                        <?php endif; ?>
                                                    <?php else: ?>
                                                        -
                                                    <?php endif; ?>
