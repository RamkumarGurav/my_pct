...
$page_module_name = "Domestic & Int Tour Booking Enquiry";

?>
<?
$name="";
$di_tour_booking_enquiry_id=0;
$status=1;
$record_action = "Add New Record";
if(!empty($di_tour_booking_enquiry_data))
{
	// $record_action = "Update";
	// $di_tour_booking_enquiry_id = $di_tour_booking_enquiry_data->di_tour_booking_enquiry_id;
	// $name = $di_tour_booking_enquiry_data->name;
	// $status = $di_tour_booking_enquiry_data->status;
            ...
            <div class="col-12">
                ...
                <div class="card ">
                    ...
                    <div class="card-header">
                        <h3 class="card-title"><?=$di_tour_booking_enquiry_data->name?></h3>
                        <div class="float-right">
							...
							?>
							<a href="<?=MAINSITE_Admin.$user_access->class_name?>/edit/<?=$di_tour_booking_enquiry_data->di_tour_booking_enquiry_id?>"> 
                    ...
                    <div class="card-body card-primary card-outline">
                            ...
                            <div class="divTable" style="display:none;">
                            	...
                            	<div class="TableRow">
                                    ...
                                    <div class="table_col">
                                        ...
                                        <? if(!empty($di_tour_booking_enquiry_data->updated_on)){echo date("d-m-Y h:i:s A" , strtotime($di_tour_booking_enquiry_data->updated_on));}else{echo "-";}?>
                                    </div>
                                </div>                           
                            	<div class="TableRow">
                                	<div class="table_col">
                                        <label class="label_content_br">Updated By<span class="colen">:</span></label>
                                        <? if(!empty($di_tour_booking_enquiry_data->updated_by_name)){echo $di_tour_booking_enquiry_data->updated_by_name;}else{echo "-";}?>
                                    </div>
                                	<div class="table_col">
                                        <label class="label_content_br">Status<span class="colen">:</span></label>
                                        <? if($di_tour_booking_enquiry_data->status==1){ ?> Active <i class="fas fa-check btn-success btn-sm "></i>
                            ...
                            <table id="" class="table table-bordered table-hover myviewtable responsiveTableNewDesign"  >
								...
								<tr>
										...
										<?=$di_tour_booking_enquiry_data->di_tour_booking_enquiry_id?></td>
										<td >
...
<?=$di_tour_booking_enquiry_data->name?></td>
<td >
                                        <strong  class="full">Email</strong>
                                        <?=$di_tour_booking_enquiry_data->email?></td>
									...
									<tr>
                                        ...
                                        <td><strong class="full">Contact No</strong><?=$di_tour_booking_enquiry_data->contactno?></td>
                                        <td colspan="1"><strong class="full">Subject</strong><?=$di_tour_booking_enquiry_data->subject?></td>
                                        <td colspan="2">
                                        <strong class="full">Enquiry Descriptrion</strong>
                                         <?=$di_tour_booking_enquiry_data->description?></td>
                                    ...
                                    <td >
                                        ...
                                        <?php if (!empty($di_tour_booking_enquiry_data->di_tour)): ?>
                                            <?php if ($di_tour_booking_enquiry_data->di_tour[0]->di_tour_variant == 1): ?>
													Domestic Tours
													<?php elseif ($di_tour_booking_enquiry_data->di_tour[0]->di_tour_variant == 2): ?>
														International Tour
                                        ...
                                        <?php if (!empty($di_tour_booking_enquiry_data->di_tour)): ?>
                                            <?=$di_tour_booking_enquiry_data->di_tour[0]->name?></td>
                                                    <?php else: ?>
                                                        -
                                                    <?php endif; ?>
                                      
                                         <td colspan="1">
                                        <strong class="full">Tour Start Date to End Date</strong>
                                        <?php if (!empty($di_tour_booking_enquiry_data->start_date_time)): ?>
                                            <?= $di_tour_booking_enquiry_data->start_date_time ?>&nbsp;&nbsp;&nbsp; to&nbsp;&nbsp;&nbsp; <?= $di_tour_booking_enquiry_data->end_date ?></td>
                                            <?php else: ?>
                                                -
                                            <?php endif; ?>
                                        ...
                                        <?php if (!empty($di_tour_booking_enquiry_data->di_tour)): ?>
                                                        <?php if (empty($di_tour_booking_enquiry_data->di_tour[0]->is_discount)): ?>
                                                            ₹<?= $di_tour_booking_enquiry_data->di_tour[0]->actual_price ?>
                                                        <?php else: ?>

                                                            ₹<?= $di_tour_booking_enquiry_data->di_tour[0]->discounted_price ?>
                                    ...
                                    <td >
                                        ...
                                        <? if(!empty($di_tour_booking_enquiry_data->updated_by_name)){echo $di_tour_booking_enquiry_data->updated_by_name;}else{echo "-";}?></td>
                                    <td >
										<strong class="full">Updated On</strong>
										<? if(!empty($di_tour_booking_enquiry_data->updated_on)){echo date("d-m-Y h:i:s A" , strtotime($di_tour_booking_enquiry_data->updated_on));}else{echo "-";}?></td>
									<td >
