				...
				<div class="card">
					...
					if ($user_access->view_module == 1) {
						...
						<div class="card-body">
							...
							<?php echo form_open(
								MAINSITE_Admin . "$user_access->class_name/di-tour-doUpdateStatus",
								array(
									'method' => 'post',
									'id' => 'ptype_list_form',
											...
											<tr>
												...
												<?php if ($user_access->update_module == 1) { ?>
													<td><input type="checkbox" name="sel_recds[]" id="sel_recds<?php echo $count; ?>"
															value="<?php echo $item->di_tour_id; ?>" /></td>
												<? } ?>
												<td>
													<?php if ($item->di_tour_variant == 1): ?>
														Domestic Tours
													<?php elseif ($item->di_tour_variant == 2): ?>
														International Tours
												...
												<td><a href="<?= MAINSITE_Admin . $user_access->class_name . "/di-tour-view/" . $item->di_tour_id ?>">
														<?= $item->name ?>
													</a>
												</td>
