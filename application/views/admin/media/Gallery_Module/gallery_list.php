										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<select name="field_name" id="field_name" class="form-control" style="width: 100%;">
													...
													<option value='ft.file_title' <? if ($field_name == 'ft.file_title') {
														echo 'selected';
													} ?>>Image Title
													</option>
				...
				<div class="card">
					...
					<div class="card-header">
						...
						<div class="float-right">
							...
							if ($user_access->add_module == 1) {
								?>
								<a href="<?= MAINSITE_Admin . $user_access->class_name ?>/gallery-add">
					...
					if ($user_access->view_module == 1) {
						...
						<div class="card-body">
							...
							<?php echo form_open(
								MAINSITE_Admin . "$user_access->class_name/gallery-doUpdateStatus",
								array(
									'method' => 'post',
									'id' => 'ptype_list_form',
									...
									<tbody>
										...
										foreach ($gallery_data as $item) {
											...
											<tr>
												...
												<? } ?>
												<td><a href="<?= _uploaded_files_ . 'main_gallery/' . $item->file; ?>" target="_blank"><img
															src="<?= _uploaded_files_ . 'main_gallery/' . $item->file; ?>" alt="Active" width="120"
												...
												<td class="text-center">
													<a class="badge badge-secondary p-2"
														href="<?= MAINSITE_Admin . $user_access->class_name . "/gallery-view/" . $item->gallery_id ?>">
														view
													</a>
												</td>
												<td>
