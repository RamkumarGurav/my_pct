...
if (!empty($video_data)) {
	...
	$file_title = $video_data->file_title;
						...
						<div class="card-body">
							...
							<div class="form-group row">
								...
								<div class="col-lg-3 col-md-4 col-sm-6">
									<label for="file_title" class="col-sm-12 label_content px-2 py-0">Video Title<span
									...
									<div class="col-sm-12">
										<input type="text" class="form-control form-control-sm" required id="file_title" name="file_title"
											value="<?= $file_title ?>" placeholder="Video Title">
									</div>
								</div>
								<div class="col-lg-3 col-md-4 col-sm-6">
									<label for="position" class="col-sm-12 label_content px-2 py-0">Video Position No.<span
											style="color:#f00;font-size: 22px;margin-top: 3px;">*</span></label>
									<div class="col-sm-12">
										<input type="number" min="1" class="form-control form-control-sm" required id="position"
											name="position" value="<?= $position ?>" placeholder="Video Position No.">
									</div>
								</div>
								<div class="col-lg-3 col-md-4 col-sm-6">
									<label for="position" class="col-sm-12 label_content px-2 py-0">Video Code<span
											style="color:#f00;font-size: 22px;margin-top: 3px;">*</span></label>
									<div class="col-sm-12">
										<input type="text" class="form-control form-control-sm" required id="file" name="file"
											value="<?= $file ?>" placeholder="Video Code">
									</div>
								</div>
...
<script>
	...
	function addNewRFQDeatilLine_video(id_video = 0) {
		...
		$.ajax({
			...
			type: 'post',
			dataType: "json",
			data: { 'id_video': id_video, 'append_id_video': append_id_video, "<?= $csrf['name'] ?>": "<?= $csrf['hash'] ?> " },
			success: function (response) {
