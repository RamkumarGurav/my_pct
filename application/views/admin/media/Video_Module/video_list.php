				...
				<div class="card">
					...
					<div class="card-header">
						...
						<div class="float-right">
							...
							if ($user_access->add_module == 1) {
								?>
								<a href="<?= MAINSITE_Admin . $user_access->class_name ?>/video-add">
					...
					if ($user_access->view_module == 1) {
						...
						<div class="card-body">
							...
							<?php echo form_open(
								MAINSITE_Admin . "$user_access->class_name/video-doUpdateStatus",
								array(
									'method' => 'post',
									'id' => 'ptype_list_form',
											...
											<tr>
												...
												<?php if ($user_access->update_module == 1) { ?>
													<td><input type="checkbox" name="sel_recds[]" id="sel_recds<?php echo $count; ?>"
															value="<?php echo $item->video_id; ?>" /></td>
												<? } ?>
												<td>
													<a href="<?= MAINSITE_Admin . $user_access->class_name . "/video-view/" . $item->video_id ?>">
														<?= $item->file ?>
													</a>
												</td>
