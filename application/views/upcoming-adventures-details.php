                ...
                <div class="sidebar-booking">
                  <div id="enquiry-form" class="sidebar-booking-form">
                    <form name="bookingform" id="bookingForm"
                      action="<?= MAINSITE . 'ajax_insert_tour_booking_enquiry' ?>" onsubmit="submitForm(event)"
                      ...
                      <input type="hidden" name="subject" id="subject" value="upcoming adventures booking" />
                      <input type="hidden" name="page" id="page"
                        value="upcoming-adventures-details/<?= $tour_data->tour_id ?>" />



                      <div class="form-group mb-4 ">
                        <select class="form-control" id="tour_date_id" name="tour_date_id"
                          style="font-size: 1.5rem; padding: 2rem; border-radius: 0.3rem;background:#F2F2F2;" required
                          data-parsley-required-message="Please select a tour date">
                      ...
                      <!-- localhost sitekey: 6LezxwUqAAAAAC7iAfqFV-2G8Q6upDtpVxHnTKQx -->
